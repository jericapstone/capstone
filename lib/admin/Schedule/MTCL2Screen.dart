// lib/admin/Schedule/MTCL2Screen.dart

import 'package:capstonesproject2024/admin/Schedule/subectinput.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class MTCL22Screen extends StatefulWidget {
  @override
  _MTCL22ScreenState createState() => _MTCL22ScreenState();
}

class _MTCL22ScreenState extends State<MTCL22Screen> {
  ...
  Future<void> _fetchSchedule() async {
    try {
      DocumentSnapshot doc =
          await _firestore.collection('schedules').doc('Mtcl2').get();
      if (doc.exists) {
